...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PunisherCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"95.211.57.108:4891", "95.211.57.108:4891"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PunisherCoin is probably already running."), addrBind.ToString().c_str());
        else
