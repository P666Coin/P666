...
#if defined(NDEBUG)
# error "PunisherCoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xf6366c18164b94c90969c0155fb92fc6b72b3ab7be54e876653fac550291d329");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // PunisherCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "PunisherCoin Signed Message:\n";
...
{
    // PunisherCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 66 * 60;
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // PunisherCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // PunisherCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf6366c18164b94c90969c0155fb92fc6b72b3ab7be54e876653fac550291d329");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1443448686, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "PunisherCoin 2015";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 666 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04cdf3d662f368bad04748248c7b2c469da1878b453d376a1a23bcfa423c73fb68846d6752bac52ea90af2e193ac92da28b0c78cf1a72803b1d5f32166d017f3b1") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1443448686;
        ...
        assert(block.hashMerkleRoot == uint256("0xf6b1f9908dfdce97fb154f3c04c508463de270f73d02d905452cfaa970cfca79"));
...
unsigned char pchMessageStart[4] = { 0x28, 0x06, 0xfb, 0x32 }; // PunisherCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("PunisherCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("PunisherCoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static PunisherCoinMiner(CWallet *pwallet)
{
    printf("PunisherCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("punishercoin-miner");
    ...
    try { loop {
        ...
        printf("Running PunisherCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("PunisherCoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&PunisherCoinMiner, pwallet));
}
